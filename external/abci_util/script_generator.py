...
def generate_script(cmd:str, script_path:str, run_dir:str, abci_log_dir:str, ex_id:str, user:str, env:str, wandb_api_key=''):
    """
    """
    ...
    with open(script_path, mode='w') as f:
        ...
        f.write('export WANDB_API_KEY={WANDB_API_KEY}\n\n'.format(WANDB_API_KEY=wandb_api_key))
